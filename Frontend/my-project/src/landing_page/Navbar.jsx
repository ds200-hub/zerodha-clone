                    ...
                    <form class="d-flex" role="search">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                ...
                                <a className='nav-link active' href=" https://zerodha-authentication.vercel.app" target='_self'>Login</a> {/*_self se hum same tab mein redirect honge aur _blank likhne se dusre tab mein redirect honge */}
                            </li>
                            <li class="nav-item">
